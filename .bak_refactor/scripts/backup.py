"""
Резервне копіювання даних бота (БД + обране) у zip із міткою часу.

Запуск:  python scripts/backup.py
Кладе архів у data/backups/bot_backup_YYYYmmdd_HHMMSS.zip і лишає
останні BACKUP_KEEP копій (старіші видаляє).
"""
